	...
	return (
		<React.Fragment>
					...
					<TabsVerticalGrid>
							...
							<Grid container spacing={2}>
								...
								<Grid item xs={12}>
									<Typography variant="body1">
										<Trans>แก้ไขแหล่งที่มาของเสียงและวิดีโอสำหรับสตรีมแบบสด เพิ่มคำอธิบาย และตั้งค่าสิทธิ์ใช้งานเนื้อหาที่คุณต้องการ</Trans>
									</Typography>
								</Grid>
								{$state.editing === false && (
									<Grid item xs={12}>
										<div className={classes.wizardButtonElement}>
											<Typography>
												<Trans>
													(<AutoFixHighIcon className={classes.inlineIcon} />) เพื่อการติดตั้งหรือแก้ไขที่รวดเร็วและง่ายดาย (
													<EditIcon className={classes.inlineIcon} />) แหล่งที่มาโดยตรงในโหมดกำหนดเอง
												</Trans>
											</Typography>
										</div>
									</Grid>
						...
						<TabPanel value={$tab} index="meta" className="panel">
							<Grid container spacing={2}>
								...
								<Grid item xs={12}>
									<Typography>
										<Trans>อธิบายสั้น ๆ ว่าผู้ชมจะเห็นอะไรระหว่างการสตรีมแบบสด</Trans>
									</Typography>
								</Grid>
								<Grid item xs={12}>
									<Divider />
						...
						<TabPanel value={$tab} index="license" className="panel">
							<Grid container spacing={2}>
								...
								<Grid item xs={12}>
									<Typography>
										<Trans>
											ใช้ลิขสิทธิ์ของคุณและเลือกสิทธิ์ใช้งานภาพที่เหมาะสม ไม่ว่าจะฟรีสำหรับทุกคนหรือจำกัดอย่างมาก อภิปรายสั้นๆ
											สิ่งที่คนอื่นได้รับอนุญาตให้ทำกับภาพของคุณ
										</Trans>
									</Typography>
								</Grid>
								<Grid item xs={12}>
			...
			<Dialog
				...
				title={<Trans>คุณต้องการยกเลิกการเชื่อมต่อ "{$data.meta.name}"?</Trans>}
				buttonsLeft={
			...
			>
				<Typography>
					<Trans>ไม่สามารถแก้ไขแหล่งที่มานี้ได้ในขณะที่ใช้งานอยู่ หากต้องการดำเนินการต่อ คุณต้องยกเลิกการเชื่อมต่อแหล่งที่มา</Trans>
				</Typography>
			</Dialog>
			<Dialog
				open={$deleteDialog}
			...
			>
				<Typography>
					<Trans>การลบช่องนี้ไม่สามารถกู้คืนได้ การเผยแพร่ทั้งหมดของช่องนี้จะถูกลบออก</Trans>
				</Typography>
			</Dialog>
