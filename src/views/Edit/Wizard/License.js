		...
		<Paper xs={12} sm={9} md={6} marginBottom="6em" className="PaperM">
			...
			<Grid container spacing={2}>
				...
				<Grid item xs={12}>
					<Typography>
						<Trans>
							ใช้ลิขสิทธิ์ของคุณและเลือกใบอนุญาตภาพที่ถูกต้อง ไม่ว่าจะฟรีสำหรับทุกคนหรือจำกัดอย่างมาก อภิปรายสั้น ๆ ว่าคนอื่นเป็นอย่างไร
							ได้รับอนุญาตให้ทำกับภาพของคุณ
						</Trans>
					</Typography>
				</Grid>
				<Grid item xs={12}>
