				...
				<Grid item xs={12}>
						...
						<BoxText color="dark">
							...
							<Typography textAlign="center">
								{props.sourceid === 'rtmp' || props.sourceid === 'hls' ? (
									<Trans>ไม่พบสตรีมแบบสด โปรดตรวจสอบซอฟต์แวร์ที่ส่งสตรีม.</Trans>
								) : (
									<Trans>ตรวจสอบแหล่งที่มาไม่สำเร็จ กรุณาตรวจสอบที่อยู่</Trans>
								)}
							</Typography>
						</BoxText>
					)}
					{props.status === 'nostream' && (
						<BoxText color="dark">
							<WarningIcon fontSize="large" color="error" />
							<Typography textAlign="center">
								<Trans>แหล่งที่มาไม่มีสตรีมวิดีโอใดๆ กรุณาตรวจสอบอุปกรณ์.</Trans>
							</Typography>
						</BoxText>
					)}
					{props.status === 'nocoder' && (
						<BoxText color="dark">
							...
							<Typography textAlign="center">
								<Trans>
									แหล่งที่มาไม่มีสตรีมวิดีโอที่เข้ากันได้ กรุณาตรวจสอบ{' '}
