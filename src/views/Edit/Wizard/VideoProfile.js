	...
	return (
		<Paper xs={12} sm={9} md={6} marginBottom="6em" className="PaperM">
			...
			<Grid container spacing={2}>
				...
				<Grid item xs={12}>
					<Typography>
						<Trans>แหล่งวิดีโอเข้ากันได้ เลือกความละเอียดที่ต้องการ:</Trans>
					</Typography>
				</Grid>
				<Grid item xs={12}>
				...
				{props.compatible === false && (
					<React.Fragment>
						{props.encodersList.length === 0 ? (
							<Grid item xs={12}>
								<Typography>
									<Trans>สตรีมของคุณต้องเข้ารหัส แต่ไม่มีโปรแกรมเปลี่ยนไฟล์ที่เหมาะสม</Trans>
								</Typography>
							</Grid>
						) : (
							<React.Fragment>
								<Grid item xs={12}>
									<Typography>
										<Trans>สตรีมของคุณต้องเข้ารหัส เลือกตัวเข้ารหัสที่ต้องการ:</Trans>
									</Typography>
								</Grid>
