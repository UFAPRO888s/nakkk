	...
	return (
		<React.Fragment>
						...
						<Grid item xs={12}>
							<Stack direction="row" spacing={1} justifyContent="space-between">
								<Stack direction="row" spacing={1} justifyContent="flex-start">
									<Typography variant="h2">ช่องรายการ</Typography>
								</Stack>
			...
			<Dialog
				...
				title={<Trans>เพิ่มช่องใหม่</Trans>}
				buttonsLeft={
			...
			>
				<Grid container spacing={2}>
					<Grid item xs={12}>
						<Typography>
							<Trans>ชื่อสำหรับช่องใหม่</Trans>
						</Typography>
					</Grid>
					<Grid item xs={12}>
						<TextField variant="outlined" fullWidth label={<Trans>TitleX</Trans>} value={$addChannel.name} onChange={handleAddChannelChange} />
					</Grid>
				</Grid>
			</Dialog>
		</React.Fragment>
